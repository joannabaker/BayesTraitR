...
For now, tutorials are included here on the homepage but they will soon be moved to separate tutorial files and upon package release, incorporated into the vignette. 
...
=======
4) [Variable-Rates Model Example](vr.html)
>>>>>>> 85552cbacae305f155a52e1e04a84b808345fd2c
...
More detailed descriptions of how to create all model types implemented in BayesTraits can be found in the tutorial pages (linked above). 
...
Now, we can read in the log file into our R workspace using the function `readBTlog` from this package. 
...
3) A variable rates model across a tree sample, forcing equal tree sampling. Note that this option is not limited to variable rates models and is equivalent to running analyses sequentially across each tree. 
